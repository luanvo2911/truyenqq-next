...
//     description:
//       'One day, Charlotte Bennett transferred to Aoyagi Akihito\'s class. Her proper and refined mannerisms and adorable appearance captured the hearts of his classmates, but Akihito calmly takes a step back, feeling that she "lives in a different world."',
...
//     tags: ["Comedy", "Romance", "Slice of Life"],
//     description:
//       "High school student Kanata Yoshino who was at his wit's end, meets Haruka Hoshikawa, the most beautiful girl of his class, who was waving her smartphone alone in a park in the middle of the night. She is bad with machines and doesn't know how to connect to the internet, and asks him to help. He ends up visiting her house, but little does he know, she has a secret purpose...!",
//     author: "Fuyutani Riku",
//   },
// ];
...
export default function Truyenqq() {
  const { response, error, isLoading } = useMangaList();
    ...
    <div className="w-full h-auto px-2 xl:px-40 py-4">
      <div>
        ...
        <div className="flex justify-around py-4 mb-8">
          <SpotlightSlider>
            {response?.map((res: Manga, index: number) => {
